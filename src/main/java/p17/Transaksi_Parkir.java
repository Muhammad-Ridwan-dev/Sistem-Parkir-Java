...
public class Transaksi_Parkir extends javax.swing.JFrame {
    ...
    private void rapikanTampilan() {
        ...
        lblIconJudul.setFont(new java.awt.Font("Segoe UI Emoji", java.awt.Font.PLAIN, 12));
        lblIconJudul.setText("<html><span style='font-size:14px;'>&#128664;</span></html>"
        );

        // Pengaturan Ikon Motor
        // Menggunakan setPreferredSize agar kotak warna lebih lebar/proporsional 
        lblIconMotor.setPreferredSize(new java.awt.Dimension(56, 56));
        lblIconMotor.setText("\uD83C\uDFCD"); 
        lblIconMotor.setFont(new java.awt.Font("Segoe UI Symbol", java.awt.Font.PLAIN, 28));
        lblIconMotor.setOpaque(false);
        lblIconMotor.setForeground(new java.awt.Color(76, 175, 80));
        lblIconMotor.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblIconMotor.setVerticalAlignment(javax.swing.SwingConstants.CENTER);
        lblIconMotor.setBorder(null);

        // Pengaturan Ikon Mobil
        lblIcoMobil.setPreferredSize(new java.awt.Dimension(56,56));
        lblIcoMobil.setText("\uD83D\uDE98");
        lblIcoMobil.setFont(new java.awt.Font("Segoe UI Symbol", java.awt.Font.PLAIN, 28));
        lblIcoMobil.setOpaque(false);
        lblIcoMobil.setForeground(new java.awt.Color(25, 118, 210));
        lblIcoMobil.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblIcoMobil.setVerticalAlignment(javax.swing.SwingConstants.CENTER);
        lblIcoMobil.setBorder(null);
    ...
    private void initComponents() {
        ...
        lblIconJudul = new javax.swing.JLabel();
        ...
        lblIconJudul.setText("<html><span style='font-size:14px; color:#2f3640;'>&#128664;</span></html>");
        panelFormTransaksi.add(lblIconJudul, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, -1, -1));
    ...
    private javax.swing.JLabel lblIconJudul;
